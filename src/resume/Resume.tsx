...
> {
  ...
  public constructor(props: {}) {
    ...
    // Set the filter date.
    this.filterDate = dayjs().subtract(7, 'year').format('YYYY-MM-DD');
          ...
          <div className="flex flex-col justify-between p-2 space-y-2 min-h-screen max-w-4xl">
            <header className="print:hidden">
              ...
              <h1 className="border-b-2 border-gray-300 font-bold text-2xl text-indigo-900 flex justify-between items-end">
                Resume
                {release !== null && <span className="text-gray-500 text-xs">v{release.version} </span>}
              </h1>
            </header>
            {/* Header */}
            <header className="p-2 rounded-lg bg-white shadow print:shadow-none flex sm:flex-row flex-col sm:space-x-4 print:flex-row print:space-x-4">
              {/* Photo, location and contacts */}
              <div className="whitespace-nowrap sm:border-r sm:pr-2 text-center sm:profile-card">
                <img
                  className="rounded-full shadow-md border-indigo-200 print:hidden m-auto mt-2 border"
                  width="202"
                  height="202"
                  alt="portrait"
                ...
                <div className="sm:pb-0 pb-4 print:pb-0">
                  ...
                  <p className="flex pb-1 text-indigo-600">
                    ...
                    <a className="pl-2" rel="noopener noreferrer" href={`tel:${resume.basics.phone}`}>
                      {resume.basics.phone}
                    </a>
                  </p>
                  {/* Email contact */}
                  <p className="flex pb-1 text-indigo-600">
                    ...
                    <a className="pl-2" rel="noopener noreferrer" href={`mailto:${resume.basics.email}`}>
                      {resume.basics.email}
                    </a>
                  </p>
                  {/* Website */}
                  <p className="flex text-indigo-600">
                    ...
                    <a className="pl-2" rel="noopener noreferrer" href={resume.basics.website}>
              ...
              <div className="flex flex-col w-full justify-between">
                ...
                <p className="text-md sm:text-xl print:text-sm">
                  {qrCode && <img className="float-right hidden print:inline" width="50" height="50" alt="QR code" src={qrCode} />}
                ...
                <div className="flex flex-row justify-between">
                  <div className="flex flex-row content-end flex-wrap text-indigo-600">
                    ...
                    {resume.basics.profiles &&
                      resume.basics.profiles.map((profile: IProfile) => <Profile key={profile.network} profile={profile} />)}
                  </div>
                  {/* Version */}
                  {release !== null && (
            ...
            <main className="flex-grow place-self-stretch">
              ...
              {(resume.education !== null || resume.languages !== null) && (
                <div className="rounded-lg bg-white shadow p-2 mb-2 print:pt-0 print:-mt-2 print:shadow-none">
                  ...
                  {resume.education !== null && (
                    <div>
                      <h2 className="border-b-2 border-gray-300 font-bold text-xl text-indigo-900">Education</h2>
                  ...
                  {resume.languages !== null && (
                    <div>
                      <h2 className="border-b-2 border-gray-300 font-bold text-xl text-indigo-900">Languages</h2>
              ...
              {resume.skills !== null && (
                <div className="rounded-lg bg-white shadow p-2 print:shadow-none">
                  <h2 className="border-b-2 border-gray-300 font-bold text-xl text-indigo-900">Technical Skills</h2>
            ...
            <footer className="rounded-lg bg-white shadow p-2 flex space-x-6 text-sm text-indigo-600 font-bold print:hidden">
              {/* Github link */}
              <a href="https://github.com/pitecus/resume-react" className="whitespace-nowrap" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" className="inline mr-1" width="24" height="24" viewBox="0 0 24 24">
              ...
              <div className="flex flex-col justify-center">
                <img
                  src="https://github.com/pitecus/resume-react/actions/workflows/node.js.yml/badge.svg"
                  width="111"
                  height="20"
  ...
  private filterWorkExperience(shouldFilter: boolean): void {
    ...
    // Filter.
    if (shouldFilter) {
      filteredExperience = this.state.resume?.work.filter((work) => work.endDate > this.filterDate);
    } else {
      // No filter.
